...
namespace MobileAutomation.Framework.Core.BaseSetup {
    internal class CustomIOSDriver : IOSDriver<AppiumWebElement> {
        
        public CustomIOSDriver(Uri remoteAddress, DriverOptions driverOptions, TimeSpan commandTimeout) : base(remoteAddress, driverOptions, commandTimeout) {
        }
